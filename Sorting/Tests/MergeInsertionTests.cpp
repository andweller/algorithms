...
{
    TEST_CLASS(MergeInsertionTests)
    {
    public:

        TEST_METHOD(MergeInsertion_Int_One)
        {
            int a[1] = { 10 };
            merge_sort_insertion_optimization(a, 1);
            Assert::AreEqual<int>(10, a[0]);
        }


        TEST_METHOD(MergeInsertion_Int_Two)
        {
            int const length = 2;
            int a[length] = { 10, 11 };
        ...
        TEST_METHOD(MergeInsertion_Int_Two_Reversed)
        {
            int const length = 2;
            int a[length] = { 11, 10 };
            merge_sort_insertion_optimization(a, length);
        ...
        TEST_METHOD(MergeInsertion_Int_Three)
        {
            int const length = 3;
        ...
        TEST_METHOD(MergeInsertion_Int_Three_Unordered)
        {
            int const length = 3;
        ...
        TEST_METHOD(MergeInsertion_Int_Three_Reversed)
        {
            int const length = 3;
        ...
        TEST_METHOD(MergeInsertion_Int_Ten)
        {
            int const length = 10;
        ...
        TEST_METHOD(MergeInsertion_Int_Ten_Unordered)
        {
            int const length = 10;
        ...
        TEST_METHOD(MergeInsertion_Int_Ten_Reversed)
        {
            int const length = 10;
