...
{
    TEST_CLASS(BubbleTests)
    {
    public:

        TEST_METHOD(Bubble_Int_One)
        {
            int a[1] = { 10 };
            bubble_sort(a, 1);
        ...
        TEST_METHOD(Bubble_Int_Two_Reversed)
        {
            int const length = 2;
            int a[length] = { 11, 10 };
            bubble_sort(a, length);
        ...
        TEST_METHOD(Bubble_Int_Three_Unordered)
        {
            int const length = 3;
        ...
        TEST_METHOD(Bubble_Int_Three_Reversed)
        {
            int const length = 3;
        ...
        TEST_METHOD(Bubble_Int_Ten_Unordered)
        {
            int const length = 10;
        ...
        TEST_METHOD(Bubble_Int_Ten_Reversed)
        {
            int const length = 10;
